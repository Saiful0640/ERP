...
import { Salaryprocessmonthly } from '../../../../models/payroll/salaryprocessmonthly.model';
...
@Component({
  ...
  styleUrls: ['./monthly-salary-process.component.scss']
})
  ...
  addRow() {
    this.arrayForm.push(
      new FormGroup({
        ...
        overTimeHour: new FormControl(null, []),
        overTimeAmount: new FormControl(null, []),
        tadaAmount: new FormControl(null, []),
        meetingAmount: new FormControl(null, []),
        absentDeductAmount: new FormControl(null, []),
        lateDeductAmount: new FormControl(null, []),
        providentFund: new FormControl(null, []),
        stampAmount: new FormControl(null, []),
        loanAmount: new FormControl(null, []),
        extentMobileBill: new FormControl(null, []),
