...
filteredItem:BasicEntryModel[]=[];
  ...
  save() {
    ...
    if (this.basicEntryForm.invalid) {
      ...
      this.basicEntryService.saveSection(this.basicEntryForm.value).subscribe((result:any) => {
        if (result) {
  ...
  update() {
    this.isSubmitted = true;
      ...
      console.log(this.basicEntryForm.value)
      this.basicEntryService.updateSection(this.basicEntryForm.value).subscribe((result:any) => {
        if (result) {
          this.toaster.success( "Success");
          this.btnStatus = "Save";
          this.getAllSection();
  ...
  getAllSection() {
    this.basicEntryService.getAllSection().subscribe((result:any) => {
      if (result) {
