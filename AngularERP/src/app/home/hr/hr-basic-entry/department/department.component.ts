...
export class DepartmentComponent implements OnInit {
  ...
  save() {
    ...
    if (this.basicEntryForm.invalid) {
      ...
      this.basicEntryService.saveDepartment(this.basicEntryForm.value).subscribe((result:any) => {
        if (result) {
  ...
  update() {
    this.isSubmitted = true;
      ...
      console.log(this.basicEntryForm.value)
      this.basicEntryService.updateDepartment(this.basicEntryForm.value).subscribe((result:any) => {
        if (result) {
          this.toaster.success( "Success");
          this.btnStatus = "Save";
          this.getAllDepartment();
  ...
  getAllDepartment() {
    this.basicEntryService.getAllDepartmentNew().subscribe((result:any) => {
      if (result) {
