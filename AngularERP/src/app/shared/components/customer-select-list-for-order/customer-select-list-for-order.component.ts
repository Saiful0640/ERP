...
@Component({
  selector: 'app-customer-select-list-for-order',
  templateUrl: './customer-select-list-for-order.component.html',
  styleUrls: ['./customer-select-list-for-order.component.scss']
})
export class CustomerSelectListForOrderComponent implements OnInit {
  @Input() modalName: any;
  ...
  getCustomer(type) {
    ...
    this.salePurchaseService.getCustomerForOrder(this.companyId, type,this.empId)
      .subscribe(response => {
