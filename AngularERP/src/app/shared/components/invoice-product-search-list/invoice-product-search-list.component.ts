...
@Component({
  selector: 'app-invoice-product-search-list',
  templateUrl: './invoice-product-search-list.component.html',
  styleUrls: ['./invoice-product-search-list.component.scss']
})
export class InvoiceProductSearchListComponent implements OnInit {
