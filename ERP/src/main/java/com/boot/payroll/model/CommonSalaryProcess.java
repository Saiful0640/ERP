...
@Entity
@Table(name="commonsalaryprocess")
public class CommonSalaryProcess {
	@Id
	...
	public CommonSalaryProcess(long id, long memberID, String memberCode, String memberName, long departmentID,
			long designationID, long compID, long periodID, long groupID, Double grossSalary, Double incrimentAmount,
			Double absentDeductAmount, int paymentType, Double overTimeAmount, Double workingDay, Double holiday,
			Double withoutPay, Double withPay, Double attendDay, Double totalDay, Double basicAmount, Double houseRent,
			Double medical, Double conveyance, Double pf, Double otherDeduction, Double incomeTax, Double loanAmount,
			Double advance, Double totalDeductAmount, Double totalAdditionAmount, Double netPayment, long userID,
			Date entryTime, String narration) {
		super();
		this.id = id;
		this.memberID = memberID;
		this.memberCode = memberCode;
