...
@Entity
@Table
@NamedStoredProcedureQueries({@NamedStoredProcedureQuery(name = "getAllEmployeementInfoByMemberCode", procedureName = "getAllEmployeementInfoByMemberCode", parameters = {
			@StoredProcedureParameter(mode = ParameterMode.IN, name = "membercode", type = String.class)},resultClasses = GetAllEmployeementInfoByMemberCode.class) })

public class GetAllEmployeementInfoByMemberCode {
	@Id
	private long id;
