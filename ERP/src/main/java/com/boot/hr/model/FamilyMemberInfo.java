...
public class FamilyMemberInfo {
	...
	public FamilyMemberInfo(Long id, String memberCode, int relationship, String fMemberName, String dateOfBirth,
			String placeOfBirth, int genderId, int bloodGroupId, int maritialStatusId, Long occupationId,
			Long countryId, String nationalityId, String passportNo, Byte[] picture, String mobileNo, String email,
			int isNominee, Long percentage, Long compId, int comType, Long moduleId, java.util.Date createdDate,
			int modifiedBy) {
		super();
		this.id = id;
		this.memberCode = memberCode;
