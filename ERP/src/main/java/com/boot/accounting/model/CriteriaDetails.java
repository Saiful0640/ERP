...
public class CriteriaDetails {
	...
	public CriteriaDetails(Long id, Long criteriaId, String detailsCaption, Long parentId, Long accountId,
			Long moduleId, Long compId, boolean status, String detailsNoste) {
		super();
		this.id = id;
		this.criteriaId = criteriaId;
		this.detailsCaption = detailsCaption;
