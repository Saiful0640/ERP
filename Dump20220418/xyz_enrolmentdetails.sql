...
--
-- Table structure for table `enrolmentdetails`
--

DROP TABLE IF EXISTS `enrolmentdetails`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `enrolmentdetails` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `avvountname` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `enrolmentdetails`
--

LOCK TABLES `enrolmentdetails` WRITE;
/*!40000 ALTER TABLE `enrolmentdetails` DISABLE KEYS */;
/*!40000 ALTER TABLE `enrolmentdetails` ENABLE KEYS */;
UNLOCK TABLES;
