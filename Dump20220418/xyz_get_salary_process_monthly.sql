...
--
-- Table structure for table `get_salary_process_monthly`
--

DROP TABLE IF EXISTS `get_salary_process_monthly`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `get_salary_process_monthly` (
  `id` bigint NOT NULL,
...
--
-- Dumping data for table `get_salary_process_monthly`
--

LOCK TABLES `get_salary_process_monthly` WRITE;
/*!40000 ALTER TABLE `get_salary_process_monthly` DISABLE KEYS */;
/*!40000 ALTER TABLE `get_salary_process_monthly` ENABLE KEYS */;
UNLOCK TABLES;
