...
--
-- Table structure for table `bonusprocess`
--

DROP TABLE IF EXISTS `bonusprocess`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `bonusprocess` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `moduleid` bigint DEFAULT NULL,
  `bonusid` bigint DEFAULT NULL,
  `bonuseamount` double DEFAULT NULL,
  ...
  `joingdate` varchar(255) DEFAULT NULL,
  ...
  `serviceperiod` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `bonusprocess`
--

LOCK TABLES `bonusprocess` WRITE;
/*!40000 ALTER TABLE `bonusprocess` DISABLE KEYS */;
/*!40000 ALTER TABLE `bonusprocess` ENABLE KEYS */;
UNLOCK TABLES;
