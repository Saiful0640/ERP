...
--
-- Table structure for table `salaryprocessmonthly`
--

DROP TABLE IF EXISTS `salaryprocessmonthly`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `salaryprocessmonthly` (
...
--
-- Dumping data for table `salaryprocessmonthly`
--

LOCK TABLES `salaryprocessmonthly` WRITE;
/*!40000 ALTER TABLE `salaryprocessmonthly` DISABLE KEYS */;
/*!40000 ALTER TABLE `salaryprocessmonthly` ENABLE KEYS */;
UNLOCK TABLES;
