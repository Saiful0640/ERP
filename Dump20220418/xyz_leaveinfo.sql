...
CREATE TABLE `leaveinfo` (
  ...
  `totakdays` int DEFAULT NULL,
  `withpay` int DEFAULT NULL,
  PRIMARY KEY (`id`)
...
LOCK TABLES `leaveinfo` WRITE;
/*!40000 ALTER TABLE `leaveinfo` DISABLE KEYS */;
/*!40000 ALTER TABLE `leaveinfo` ENABLE KEYS */;
UNLOCK TABLES;
